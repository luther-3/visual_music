...
- 音频播放与视觉效果同步
- 目标帧率：60 FPS
- Beat 驱动粒子脉冲：节拍点触发粒子短时增强
- 三层频段环形 HUD：低/中/高频分别对应一层环，半径/厚度/亮度随幅度变化
- 调色板按段落自动切换：基于 8~16 秒窗口能量统计，在 `cool/warm/electric` 主题间平滑过渡
- 粒子形态多样化：低频雾点扩散、中频短弧 ribbon、高频十字星芒
- 简单后期（低成本）：暗角 vignette 提升画面聚焦
